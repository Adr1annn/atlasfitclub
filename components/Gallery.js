...
const Gallery = ({ title, layout }) => {
  ...
  return  <section className='p-[20px]'>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 h-1600px lg:h-400px gap-5 mb-[20px]">
              <div className='relative'>
                <Image src='/Gallery/Gallery_18.webp' layout='fill' objectFit='cover'/>
              </div>
              <div className='relative'>
                <Image src='/Gallery/Gallery_19.webp' layout='fill' objectFit='cover'/>
              </div>
              <div className='relative'>
                <Image src='/Gallery/Gallery_17.webp' layout='fill' objectFit='cover'/>
              </div>
              <div className='relative'>
                <Image src='/Gallery/Gallery_10.webp' layout='fill' objectFit='cover'/>
              </div>
            </div>
            <div className="grid lg:grid-cols-2 gap-5 h-400px">
              <div className='relative'>
                <Image src='/Gallery/Gallery_20.webp' layout='fill' objectFit='cover'/>
              </div>
              <div className='relative'>
                <Image src='/Gallery/Gallery_21.webp' layout='fill' objectFit='cover'/>
              </div>
            </div>
            {
              layout === 'all' ?
              <div className='py-[20px]'>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 h-1600px lg:h-400px mb-[20px]">
                  <div className='relative'>
