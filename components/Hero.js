...
const Hero = () => {
  ...
  return  <section className="bg-[url('/hero-1.jpg')] h-[calc(100vh-100px)] bg-no-repeat bg-cover bg-top">
            <div className='pt-[220px] text-shadow-lg'>
              ...
              <p className='max-w-[600px] mx-auto text-center text-white mt-[10px]'>Atlas Fit Club este o sală la cele mai înalte standarde, cu aparate noi, de top cu ajutorul cărora poti să îți atingi potențialul maxim. În sala de aerobic se țin clase variate, cu antrenori bine pregătiți.</p>
              <button 
